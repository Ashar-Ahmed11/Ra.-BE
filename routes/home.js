...
const migrateImageFields = async(document, fields, type, summary) => {
    ...
    for (const field of fields) {
        ...
        try {
            document[field] = await uploadImageToCloudinary(`https://res.cloudinary.com/mtces9mu/image/fetch/q_60/${currentUrl}`)
...
router.post('/createhome', async(req, res) => {
    ...
    try {
        ...
        const data = {
            user: admin._id,
            mainCarousalImgDesktop:'https://res.cloudinary.com/mtces9mu/image/upload/v1678537550/knpz1pszgqkze7iwv3hm.avif',
          mainCarousalImgPhone: 'https://res.cloudinary.com/mtces9mu/image/upload/v1677446793/piefl0qw89izkoh300fd.png',
            ...
            bodyImg: 'https://res.cloudinary.com/mtces9mu/image/upload/v1676748951/xyxuzlzsmnyr7mbjse4m.png',
            ...
            footerCarousalImgDesktop: 'https://res.cloudinary.com/mtces9mu/image/fetch/f_webp/q_60/https://res.cloudinary.com/mtces9mu/image/upload/v1676748976/tbgvwfdtgixrwqoj0ldn.png',
            footerCarousalImgPhone: 'https://res.cloudinary.com/mtces9mu/image/fetch/f_webp/q_60/https://res.cloudinary.com/mtces9mu/image/upload/v1676748998/aikg308x1vsartenlm4p.png'
        }
