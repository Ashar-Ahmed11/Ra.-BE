...
router.post('/createorder', async (req, res) => {
    try {
        ...
        const { name, email, products, total, subtotal, country, city, phone, address } = req.body;
        const order = new Order({ name, email, products, total, subtotal, country, city, phone, address });
